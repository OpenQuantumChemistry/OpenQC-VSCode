...
export class CompletionProvider implements vscode.CompletionItemProvider {
    ...
    private getVASPCompletions(line: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            { label: 'ENCUT', kind: vscode.CompletionItemKind.Property, detail: 'Energy cutoff (eV)', documentation: 'Specifies the cutoff energy for the plane wave basis set' },
            { label: 'PREC', kind: vscode.CompletionItemKind.Property, detail: 'Precision', documentation: 'Determines the precision of the calculation' },
            { label: 'EDIFF', kind: vscode.CompletionItemKind.Property, detail: 'Electronic convergence', documentation: 'Convergence criterion for electronic relaxation' },
            { label: 'NELM', kind: vscode.CompletionItemKind.Property, detail: 'Max electronic steps', documentation: 'Maximum number of electronic self-consistency steps' },
            { label: 'ISMEAR', kind: vscode.CompletionItemKind.Property, detail: 'Smearing method', documentation: 'Determines how the partial occupancies are set for each orbital' },
            { label: 'SIGMA', kind: vscode.CompletionItemKind.Property, detail: 'Smearing width', documentation: 'The width of the smearing in eV' },
            { label: 'IBRION', kind: vscode.CompletionItemKind.Property, detail: 'Ionic relaxation', documentation: 'Determines how the ions are updated and moved' },
            { label: 'NSW', kind: vscode.CompletionItemKind.Property, detail: 'Max ionic steps', documentation: 'Maximum number of ionic steps' },
            { label: 'ISIF', kind: vscode.CompletionItemKind.Property, detail: 'Stress/relaxation', documentation: 'Determines whether the stress tensor is calculated' },
            { label: 'ISPIN', kind: vscode.CompletionItemKind.Property, detail: 'Spin polarization', documentation: 'Specifies whether spin-polarized calculation is performed' },
            { label: 'MAGMOM', kind: vscode.CompletionItemKind.Property, detail: 'Magnetic moments', documentation: 'Initial magnetic moments for each atom' },
            { label: 'LREAL', kind: vscode.CompletionItemKind.Property, detail: 'Real space projection', documentation: 'Determines whether the projection operators are evaluated in real space' },
            { label: 'ALGO', kind: vscode.CompletionItemKind.Property, detail: 'Algorithm', documentation: 'Selects the algorithm for electron optimization' },
            { label: 'LWAVE', kind: vscode.CompletionItemKind.Property, detail: 'Write WAVECAR', documentation: 'Determines whether the wavefunctions are written to WAVECAR' },
            { label: 'LCHARG', kind: vscode.CompletionItemKind.Property, detail: 'Write CHGCAR', documentation: 'Determines whether the charge densities are written to CHGCAR' },
        ];
    ...
    private getGaussianCompletions(line: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            ...
            { label: 'MP2', kind: vscode.CompletionItemKind.Method, detail: 'Second-order Møller-Plesset' },
            { label: 'CCSD', kind: vscode.CompletionItemKind.Method, detail: 'Coupled Cluster Singles and Doubles' },
            ...
            { label: '6-311G(d,p)', kind: vscode.CompletionItemKind.Struct, detail: 'Pople basis set with polarization' },
            { label: 'def2-TZVP', kind: vscode.CompletionItemKind.Struct, detail: 'Ahlrichs basis set' },
            { label: 'cc-pVTZ', kind: vscode.CompletionItemKind.Struct, detail: 'Dunning correlation consistent' },
        ];
    ...
    private getORCACompletions(line: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            ...
            { label: 'OPT', kind: vscode.CompletionItemKind.Keyword, detail: 'Geometry optimization' },
            { label: 'FREQ', kind: vscode.CompletionItemKind.Keyword, detail: 'Frequency calculation' },
            { label: 'TightSCF', kind: vscode.CompletionItemKind.Keyword, detail: 'Tight SCF convergence' },
    ...
    private getCP2KCompletions(line: string, content: string): vscode.CompletionItem[] {
        ...
        if (line.trim().startsWith('&')) {
            items.push(
                ...
                { label: 'GEO_OPT', kind: vscode.CompletionItemKind.Struct, detail: 'Geometry optimization' }
            );
        } else {
            items.push(
                ...
                { label: 'METHOD', kind: vscode.CompletionItemKind.Property, detail: 'Electronic structure method' },
                { label: 'BASIS_SET_FILE_NAME', kind: vscode.CompletionItemKind.Property, detail: 'Basis set file' },
                { label: 'POTENTIAL_FILE_NAME', kind: vscode.CompletionItemKind.Property, detail: 'Potential file' }
            );
        }
    ...
    private getQECompletions(line: string, content: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            { label: 'calculation', kind: vscode.CompletionItemKind.Property, detail: 'Type of calculation' },
            { label: 'restart_mode', kind: vscode.CompletionItemKind.Property, detail: 'Restart mode' },
            { label: 'pseudo_dir', kind: vscode.CompletionItemKind.Property, detail: 'Pseudopotential directory' },
            ...
            { label: 'ecutwfc', kind: vscode.CompletionItemKind.Property, detail: 'Wavefunction cutoff (Ry)' },
            { label: 'ecutrho', kind: vscode.CompletionItemKind.Property, detail: 'Charge density cutoff (Ry)' },
            { label: 'conv_thr', kind: vscode.CompletionItemKind.Property, detail: 'Convergence threshold' },
            { label: 'diagonalization', kind: vscode.CompletionItemKind.Property, detail: 'Diagonalization method' },
            { label: 'mixing_mode', kind: vscode.CompletionItemKind.Property, detail: 'Charge mixing mode' },
        ];
    ...
    private getGAMESSCompletions(line: string, content: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            ...
            { label: 'SCFTYP', kind: vscode.CompletionItemKind.Property, detail: 'SCF type (RHF/UHF/ROHF)' },
            ...
            { label: 'NDFUNC', kind: vscode.CompletionItemKind.Property, detail: 'd functions on heavy atoms' },
            { label: 'NPFUNC', kind: vscode.CompletionItemKind.Property, detail: 'p functions on H' },
            { label: 'DIFFSP', kind: vscode.CompletionItemKind.Property, detail: 'Diffuse functions on heavy atoms' },
            { label: 'DIFFS', kind: vscode.CompletionItemKind.Property, detail: 'Diffuse functions on H' },
        ];
    ...
    private getNWChemCompletions(line: string, content: string): vscode.CompletionItem[] {
        const items: CompletionItem[] = [
            ...
            { label: 'xc', kind: vscode.CompletionItemKind.Property, detail: 'Exchange-correlation functional' },
            { label: 'convergence', kind: vscode.CompletionItemKind.Property, detail: 'Convergence criteria' },
